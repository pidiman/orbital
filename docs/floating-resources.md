...
Manual pickups in any viewed region credit the existing Home Materials/Minerals inventory or global trade-goods Xenocrystal inventory. This is a manual floating bonus, not remote mining or outpost hauling. Material Ships remain Home-only, target Materials only and reuse `salvage(..., receiver, 1)`; their cargo, depot delivery and storage-full behavior are unchanged. Outpost mining still credits local storage.
