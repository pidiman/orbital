...
Fit grid, −, and + are always visible at the left of the bottom message bar by default, in every region and with panels closed. Equal side reservations keep the message centered without overlap. Directional arrow buttons have been removed.
